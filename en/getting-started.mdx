...
<Steps>
  <Step title="Install BeeSwarm">
    ...
    **On mobile (iOS)** Open [mobile.beeswarm.app](https://mobile.beeswarm.app) in Safari, tap the share icon and select **"Add to Home Screen"**. The app will be installed like any other application.
    ...
    ![iOS installation](https://media.beeswarm.app/ios-installation-beeswarm.gif)
    ...
    **On mobile (Android)** Open [mobile.beeswarm.app](https://mobile.beeswarm.app) in Chrome. The browser will automatically display the **"Install app"** option. Tap to confirm.
    ...
    ![Android installation](https://media.beeswarm.app/android-installation-beeswarm.gif)
  </Step>
